...
public class ItemController {
    ...
    @PostMapping
    public ItemResponseDto addItem(@RequestHeader(value = HEADER, required = false) String ownerId,
    ...
    public CommentResponseDto addItemComment(@RequestHeader(value = HEADER, required = false) String userId,
    ...
    @PatchMapping("/{itemId}")
    public ItemResponseDto updateItem(@RequestHeader(value = HEADER, required = false) String userId,
    ...
    @GetMapping
    public List<ItemCommentResponseDto> findItemsUser(@RequestHeader(HEADER) String userId) {
        log.info("Получен запрос на получение всех вещей пользователя {}", userId);
        return itemService.findItemsUser(userId);
    }

    @GetMapping("/{itemId}")
    public ItemCommentResponseDto findItemId(@RequestHeader(HEADER) String userId,
    ...
    @GetMapping("/search")
    public List<ItemResponseDto> findSearchItems(@RequestHeader(HEADER) String userId,
    ...
    public void deleteItem(@RequestHeader(HEADER) String userId, @PathVariable Long itemId) {
